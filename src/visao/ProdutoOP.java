...
public class ProdutoOP extends javax.swing.JFrame {

    /**
     * Creates new form Produto Operação
     */
    public ProdutoOP() {
        initComponents();
    ...
    public void readT(){
    ProdutoDAO am = new ProdutoDAO();
        DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
        modelo.setNumRows(0);
            for (Produto a: am.listar()) {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
                    .addComponent(jPreco))
    ...
    private void jAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAdicionarActionPerformed
       ...
       Double preco = Double.parseDouble(jPreco.getText());
        Produto a = new Produto(descricao, preco);
        ProdutoDAO am = new ProdutoDAO();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        jDescricao.setText(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 1)));
        jPreco.setText(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 2)));
    ...
    private void jAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAtualizarActionPerformed
       ...
       Object id = jTable1.getValueAt(jTable1.getSelectedRow(), 0);
        ...
        a.setIdproduto(Integer.parseInt(i));
        a.setDescricao(jDescricao.getText());
        a.setPreco(Double.valueOf(jPreco.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutoOP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
